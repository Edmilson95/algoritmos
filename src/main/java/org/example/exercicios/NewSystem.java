...
import org.example.estruturadados.teste.Contato;

import java.util.ArrayList;
import java.util.Scanner;

public class NewSystem extends SistemaMenu{
    public static void main(String[] args) {
        ...
        System.out.println("Usuário digitou 0 e saiu do programa.");
    }
    ...
    private static void adicionarContatoPosicaoEspecifica(Scanner scan, ArrayList<Contato> lista) {
